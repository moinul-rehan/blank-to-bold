...
import { useRoomCamera, type RoomCameraTarget } from "@/features/studio/use-room-camera";
...
const HOTSPOTS: {
  ...
  { id: "window", title: "Future Vision", subtitle: "Where this is heading", x: 16, y: 34 },
  { id: "whiteboard", title: "Systems Thinking", subtitle: "Architecture & flows", x: 42, y: 20 },
  { id: "photo-frame", title: "About", subtitle: "Get to know Rehan", x: 58, y: 22 },
  { id: "sticky-notes", title: "Playground", subtitle: "Quick experiments", x: 90, y: 28, align: "right" },
  { id: "bookshelf", title: "Learning Journey", subtitle: "Books & timeline", x: 90, y: 48, align: "right" },
  { id: "sketchbook", title: "Process", subtitle: "How thinking becomes design", x: 32, y: 75 },
  { id: "notebook", title: "Journal", subtitle: "Thoughts, lessons, growth", x: 40, y: 80 },
  { id: "monitor", title: "Selected Work", subtitle: "Explore my projects", x: 50, y: 58 },
  { id: "mug", title: "Random Facts", subtitle: "Small personal details", x: 66, y: 72 },
  { id: "drawer", title: "Hidden Playground", subtitle: "Unreleased concepts", x: 58, y: 86 },
];
    ...
    <div className="relative h-full w-full overflow-hidden bg-black">
      <div ref={stageRef} className="absolute inset-0" style={{ transformStyle: "preserve-3d" }}>
        ...
        {/* Desk — a real 3D model (see desk-model-3d.tsx for why), not a flat image like the rest of the room.
            ...
            line instead of floating above it, and sized up 10% per follow-up feedback. */}
        <div className="absolute" style={{ left: "22%", width: "57%", bottom: "14%", height: "29%" }}>
          <DeskModel3D />
        </div>
        ...
        >
          ...
          <span className="bg-background/90 border-border pointer-events-none absolute top-1/2 left-full ml-3 flex -translate-y-1/2 flex-col items-start gap-0.5 rounded-md border px-3 py-2 whitespace-nowrap opacity-0 shadow-lg backdrop-blur-sm transition-opacity duration-300 group-hover:opacity-100">
            <span className="text-foreground text-xs font-medium">Light / Dark</span>
            <span className="text-muted-foreground text-[0.65rem]">Change the mood</span>
          </span>
        </button>
