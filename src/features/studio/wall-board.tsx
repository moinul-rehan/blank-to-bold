 ...
 * board; moved right twice per feedback (left 42 → 48 → 80), which the
 * hotspot position in room-stage.tsx was NOT moved to match — the dot no
 * longer lands on the board at all at this position. At left:80% it also
 * sits close to the "sticky-notes" (x:90, y:28) and "bookshelf" (x:90,
 * y:48) hotspots — worth checking against a screenshot for crowding.
...
export function WallBoard() {
  return (
    <div
      ...
      style={{ left: "80%", top: "20%", width: "7.5%", aspectRatio: "4 / 3" }}
    >
      {/* Frame */}
      <div
